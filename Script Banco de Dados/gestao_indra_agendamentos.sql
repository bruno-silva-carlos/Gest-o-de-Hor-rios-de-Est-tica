...
CREATE TABLE `agendamentos` (
  ...
  CONSTRAINT `FK_AGENDAMENTOS_CLIENTES` FOREIGN KEY (`ClienteId`) REFERENCES `pessoas` (`Id`),
  CONSTRAINT `FK_AGENDAMENTOS_PROFISSIONAIS` FOREIGN KEY (`ProfissionalId`) REFERENCES `pessoas` (`Id`),
...
-- Dump completed on 2021-06-25 12:28:59
